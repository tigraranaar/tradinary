                    ...
                    >
                        ...
                        <div className='glass p-8 md:p-12 rounded-lg space-y-8 text-gray-300'>
                            ...
                            <section>
                                ...
                                <h3 className='text-xl font-medium text-white mb-3 mt-6'>1.1 Personal Information</h3>
                                <p className='leading-relaxed mb-4'>
                                    When you use Tradinary, we may collect:
                                </p>
                                ...
                                <h3 className='text-xl font-medium text-white mb-3 mt-6'>1.2 Cookies and Tracking</h3>
                                <p className='leading-relaxed mb-4'>
                                ...
                                <h3 className='text-xl font-medium text-white mb-3 mt-6'>1.3 Google Analytics</h3>
                                <p className='leading-relaxed mb-4'>
                                    We use Google Analytics to understand how users interact with Tradinary. Google Analytics may collect:
                                </p>
                                <ul className='list-disc list-inside space-y-2 ml-4 mb-4'>
                                ...
                                <h3 className='text-xl font-medium text-white mb-3 mt-6'>1.4 Third-Party Services</h3>
                                <p className='leading-relaxed'>
                            ...
                            <section>
                                <h2 className='text-2xl font-semibold text-white mb-4'>3. Sharing and Disclosure</h2>
                                <p className='leading-relaxed mb-4'>
                            ...
                            <section>
                                ...
                                <p className='leading-relaxed'>
                                    We keep personal data only as long as necessary to provide the Service, comply with legal obligations, and resolve disputes.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className='leading-relaxed mb-4'>
                                    You can contact us through <Link href='/contact' className='text-white hover:underline'>tradinary.ai/contact</Link> to:
                                </p>
                                <ul className='list-disc list-inside space-y-2 ml-4'>
                            ...
                            <section>
                                ...
                                <p className='leading-relaxed'>
                                    We use reasonable measures to protect your data from unauthorized access, alteration, disclosure, or destruction.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className='leading-relaxed'>
                                    If you have questions about your data, reach us at <Link href='/contact' className='text-white hover:underline'>tradinary.ai/contact</Link>.
                                </p>
                            </section>
                        </div>
                    </motion.div>
