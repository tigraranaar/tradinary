            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-white/60">
                        {'Select your trading pair and timeframe to analyze'}
                    </p>
                </div>

                {/* Error Message */}
                {error && (
                    <div className="glass rounded-xl p-4 mb-6 border border-red-500/40 bg-red-500/10 backdrop-blur-lg">
                        <div className="flex items-center gap-3">
                            <IoAlertCircle className="text-red-400 text-xl flex-shrink-0" />
                ...
                {/* Controls Section */}
                <div className="glass rounded-2xl p-8 backdrop-blur-lg mb-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                className="w-full glass rounded-xl px-4 py-3 flex items-center justify-between hover:bg-white/15 transition-all backdrop-blur-lg disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                            ...
                            {/* Pair Dropdown Menu */}
                            {isPairOpen && (
                                <div className="absolute z-10 w-full mt-2 bg-[#190029] rounded-xl overflow-hidden shadow-xl border border-white/10 max-h-60 overflow-y-auto">
                                    {pairs.map((pair) => (
                                        <button
                                            key={pair.symbol}
                                            onClick={() => {
                        ...
                        <div className="relative">
                            ...
                            >
                                <span className="font-medium">
                                {loadingPairs ? 'Loading timeframes...' : selectedTimeframe || 'Select a timeframe'}
                                </span>
                                <IoChevronDown
                                    className={`transition-transform ${
                            ...
                            {isTimeframeOpen && (
                                <div className="absolute z-10 w-full mt-2 bg-[#190029] rounded-xl overflow-hidden shadow-xl border border-white/10">
                    ...
                    <button
                        ...
                        className="w-full btn bg-gradient-to-r from-purple-600 to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed py-3 text-base font-semibold"
                    >
                        {loadingSignal ? (
                ...
                {signal && (
                    <div className="glass rounded-2xl p-8 backdrop-blur-lg">
                        <h2 className="text-2xl font-semibold mb-6">Signal Analysis</h2>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            >
                                <p className="text-sm text-white/60 mb-2">Signal</p>
                                <div className="flex items-center gap-3">
                                    {(() => {
                                        ...
                                        return (
                                            <SignalIcon
                                                className={`text-4xl ${
                                                    getSignalDisplay(signal.signal).color
                                                }`}
                                            />
                                        );
                                    })()}
                        ...
                        {(signal.analysis || signal.recommendation) && (
                            <div className="mt-6 glass rounded-xl p-6 backdrop-blur-lg">
